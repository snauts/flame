...
(defun mountain-level ()
  (join
   ...
   (empty 2)
   (alps-walk :width 1 :base 1 :hang 1 :type 3)
   (empty 2)
   (alps-walk :width 1 :base 2 :hang 1 :type 6)
   (empty 2)
   (alps-walk :width 1 :base 3 :hang 1)
   (empty 2)
   (place 0 3 (empty 1) (alps-walk :width 1 :type '(2 5) :hang 1))
   (empty 2)
   (place 0 5 (empty 1) (alps-walk :width 1 :type '(3 6) :hang 1))
   (empty 2)
   ...
   (empty 2)
   (alps-walk :width 1 :type '(0 5))
   (empty 2)
   (alps-walk :width 1 :type '(0 6))
   (empty 2)
   (alps-walk :width 1 :type '(0 7))
   (empty 2)
   (alps-walk :width 1 :type '(0 8))
   (empty 2)
   (alps-walk :width 1 :base 1)
   (empty 2)
   (place 0 3 (empty 1) (alps-walk :width 1 :type '(1 5) :hang 1))
   (empty 2)
   (place 0 5 (empty 1) (alps-walk :width 1 :type '(2 6) :hang 1))
   (empty 2)
   (place 0 7 (empty 1) (alps-walk :width 1 :type '(3 7) :hang 1))
   (empty 2)
   (place 0 9 (empty 1) (alps-walk :width 1 :type '(4 8) :hang 1))
   (empty 64)))
