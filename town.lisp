...
(defparameter *town-walkable*
  '(130 138 146 154 162 170 136 144 152 248))
...
(defun king-side-pillar (shingle-offset)
  (s-push (town-wall 1 3))
  (s-place 1 10 (town-wall-top 0 1))
  (s-place 2 13 (lamp-post :base-h 2 :post-h 2 :brick 240))
  (s-place shingle-offset 8 (shingles 8 :hang t))
  (s-place (- 1 shingle-offset) 9 (wall-join 1))
  (s-pop))
...
(defun king-level ()
  ...
  (s-place 20 6 (town-wall-top 3 1))
  (s-place 20 5 (wall-join 6))
