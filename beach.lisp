...
(defun bamboo-trampoline ()
  (s-push (bamboo-latice 3 2))
  (s-place 2 4 (bamboo-latice 2 2))
  (s-place 4 9 (bamboo-latice 1 2))
  (s-place 5 13 (bamboo-platform :width 2))
  (s-place 4 8 (bamboo-platform :width 0 :toping '(1) :pos 1))
  (s-place 2 3 (bamboo-platform :width 1 :toping '(1 1) :pos 1))
  (s-place 7 11 (diagonal-stick 1 :end (tile 167 :h 1)))
  (s-place 0 1 (beach-map '((0 0 nil) (0 0 181) (0 181 nil))))
  (s-place 0 0 (beach-map '((181 191 183 191 183 191 183 189))))
  (s-place 3 2 (beach-map '((159 151 159 151))))
  (s-place 9 12 (beach-cell 143 :h 1))
  (s-place 4 12 (beach-map '((0 181))))
  (s-place 2 7 (beach-map '((0 181))))
  (s-place 7 12 (beach-cell 250))
  (s-place 7 11 (beach-cell 144))
  (s-pop))

(defun hermit-level ()
  (setf *seed* 2001)
  (s-push (dune-segment :width 8))
  (s-place 8 2 (bamboo-trampoline))
  (s-place 8 1 (sand-bamboo-stubs '(0 1 2 3)))
  (s-place 35 2 (flip (bamboo-trampoline)))
  (s-place 40 1 (sand-bamboo-stubs '(0 1 2 3)))
  (s-place 19 1 (watchtower-plant 3 242))
  (s-place 21 1 (watchtower-plant 6 234))
  (s-place 27 1 (watchtower-plant 10 234))
