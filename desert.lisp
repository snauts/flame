...
(defun double-platform (&key (h 0) (n 0))
  (box-pipe
   ...
   (place 3 (+ h 7) pipe (make 1 1 :e (tile 234 :pl 1)))
   ...
   (place 0 2 pipe (crop 9 2 10 3 (cliffs)))
   (place 0 3 pipe (make 1 1 :e (tile 0 :pl 1)))
   (place 13 2 pipe (flip-horizontally (crop 9 2 10 3 (cliffs))))
   (place 13 3 pipe (make 1 1 :e (tile 0 :pl 1)))
